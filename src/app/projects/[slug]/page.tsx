...
export default async function ProjectDetailPage({
  ...
  return (
    <main
      className="flex flex-1 flex-col items-center gap-10 px-4 py-16 sm:gap-14 sm:py-24 lg:gap-20 lg:py-32"
    ...
    >
      ...
      {detail ? (
        <>
          ...
          <div className="grid w-full max-w-5xl grid-cols-1 gap-6 sm:grid-cols-[482fr_635fr] sm:gap-8 lg:max-w-[73.75rem]">
        ...
        <div className="flex w-full max-w-5xl flex-col gap-4 rounded-[1.25rem] bg-[rgba(208,234,255,0.1)] p-6 sm:p-8 lg:p-10">
          <p className="font-medium text-base text-white sm:text-lg lg:text-xl">
            {project.description}
          </p>
