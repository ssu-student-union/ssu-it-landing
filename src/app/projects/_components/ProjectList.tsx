        ...
        <div className="flex items-center gap-6 sm:gap-8">
          {Array.from({ length: totalPages }, (_, index) => (
            <button
              ...
              className={
                page === index
                  ? "flex size-6 items-center justify-center rounded-full bg-[#ededed] font-bold text-[#454a4d] text-sm sm:size-7 sm:text-lg lg:size-7 lg:text-lg min-[1440px]:size-7 min-[1440px]:text-xl"
                  : "font-bold text-sm text-white sm:text-lg lg:text-lg min-[1440px]:text-xl"
              }
            >
              {index + 1}
            </button>
