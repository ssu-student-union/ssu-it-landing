  ...
  return (
    <footer className="flex w-full flex-col justify-between gap-8 bg-[#f2f3f4] px-4 py-10 sm:px-8 sm:py-12 lg:h-87 lg:gap-0 lg:px-36 lg:py-16">
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center gap-1">
            ...
            <span className="font-semibold text-[#1b1c1c] text-base sm:text-lg lg:text-lg 1440:text-xl">
              IT지원위원회
            </span>
          </div>
          <p className="text-[#1b1c1c] text-xs sm:text-sm lg:text-sm 1440:text-[0.9375rem]">
      ...
      <div className="flex flex-col gap-1">
        <p className="font-semibold text-[#1b1c1c] text-[0.6875rem] sm:text-xs lg:text-xs 1440:text-[0.8125rem]">
          위치 : 학생회관 211호
        </p>
        <div className="flex items-center gap-1">
          <Image src={copyright} alt="" className="size-3" />
          <p className="font-medium text-[#1b1c1c] text-[0.6875rem] sm:text-xs lg:text-xs 1440:text-[0.8125rem]">
